 ...
 * @param {String} integrationBranchName The attempted integration branch name.
 */
exports.mergePullRequest = function * (runtime, bugId, pull, integrationBranchName) {
  ...
  yield removeBranch(runtime, repoParts[0], repoParts[1], integrationBranchName);
