...
exports.processAttachments = function * (runtime, bugId) {
  ...
  for (var i = 0, iLen = attachments.length; i < iLen; i++) {
    ...
    if (canLand(bug, attachment)) {
      ...
      var getRequest = thunkify(runtime.githubApi.pullRequests.get.bind(runtime.get));
      ...
      var mergeRequest = thunkify(runtime.githubApi.pullRequests.merge.bind(runtime.githubApi));
