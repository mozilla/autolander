 ...
 * Comment on the pull request and remove checkin-needed if any commit does not contain a bug number.
 * @param {Object} runtime
 * @param {Object} pull
...
exports.pullRequestCommitsHasBug = function * (runtime, pull, bug) {
  ...
  for (var i = 0; i < commits.length; i++) {
    ...
    if (!parsedBugId || !parsedBugId[1]) {
      // Comment on the github pull request and remove checkin-needed if the bug has checkin-needed.
