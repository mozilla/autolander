...
exports.initApi = function *(config, azureApi) {
  ...
  return {
    ...
    subscribe: function * (runtime, bugId) {
      ...
      var insertOrReplaceEntity = thunkify(runtime.azureApi.insertOrReplaceEntity.bind(runtime.azureApi));
      yield insertOrReplaceEntity('boogz', {
        PartitionKey: 'bug',
        RowKey: bugId
      });
    },
    ...
    unsubscribe: function * (runtime, bugId) {
      ...
      var deleteEntity = thunkify(runtime.azureApi.deleteEntity.bind(runtime.azureApi));
      yield deleteEntity('boogz', {
        PartitionKey: 'bug',
        RowKey: String(bugId)
      }, {force: true});
